...
export default class FilterTreeNode extends EventsEmitter {
  ...
  /////////////////////////////////////////////////////////
  expand() {
    const target = this.domContainer.parentElement.parentElement;
...
class ReactTreeNode extends React.Component {
  ...
  /////////////////////////////////////////////////////////
  render() {
    const classNames = ['treenode', ...this.props.className.split(' ')];

    return (
      <div className={classNames.join(' ')}>
        <Switch
          onChange={checked => this.props.onChecked(checked)}
